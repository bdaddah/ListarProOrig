...
import {BookingStandardStyleModel} from '@models+types';
...
type StandardStyleProps = {
  bookingStyle: BookingStandardStyleModel;
  onUpdate: () => void;
};

const Standard: React.FC<StandardStyleProps> = ({bookingStyle, onUpdate}) => {
